...
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('Nate','Meyer','admin',SHA1('admin'),'fauxfurlan@gmail.com');
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('admin','admin','admin',SHA1('admin'),'amdin@admin');
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('reader','reader','reader',SHA1('reader'),'reader@reader');
