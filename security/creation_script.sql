...
INSERT INTO roles (Name,Description) VALUES ('manager','Update/Read privileges.');
...
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('David','Hartley','dhartley',SHA1('qwerty'),'dhartley@clarion.edu');
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('admin','admin','atadlgin',SHA1('br4inSt0rm%'),'amdin@admin');
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('Jon',"O'Donnel",'jodonnel',SHA1('admin'), 'jodonnel@clarion.edu');
INSERT INTO users (FirstName,LastName,UserName,Password,Email) VALUES ('guest','guest','guest',SHA1('guest'),'guest@guest');
