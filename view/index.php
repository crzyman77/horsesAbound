...
<!--      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <div class="col-lg-6 col-auto mb-4">
        ...
        eleifend sapien. Vestibulum purus quam, scelerisque ut, mollis sed, nonummy id, metus. Nullam accumsan 
        lorem in dui. Cras ultricies mi eu turpis hendrerit fringilla. Vestibulum ante ipsum primis in faucibus 
        ...
        Vestibulum volutpat pretium libero. Cras id dui. Aenean ut
              ...
              <div class='col-lg-4 col-auto'>
                  <img src="../images/facebookExample.png" alt="Mountain View">
              </div>
          </div>
           /.row 
